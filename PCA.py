...
data_dir = '/home/eunji/project_dir/sodescar/data/socar_usage_processed.csv'
...
drop_col = ['member_id', 'member_gender','region',
            ...
            'member_created_date','car_name','car_type']
...
# 표준화 작업
df_scaled = MinMaxScaler().fit_transform(df_x)
df_scaled = df.dropna()
...
#pca_pred = pd.DataFrame(pca.fit_transform(df_scaled))
...
# 2차원 시각화
sns.scatterplot(principal_df[0], principal_df[1], data=principal_df, hue ='car_type_mode', style='car_type_mode', s=100)
