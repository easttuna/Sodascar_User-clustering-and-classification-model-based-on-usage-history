...
## `[STEP4.] user 유형 예측 모델 생성 및 검증`
- 클러스터링을 통해 얻은 네개의 군집을 정답 레이블로 하여 각 user의 5회 이용이력만을 바탕으로 user변수를 생성하여 user들의 유형을 분류하는 모델을 생성함  
...
![image](https://user-images.githubusercontent.com/65028694/149095151-384c77e1-ffc6-45a5-b42f-d2d69999dd51.png)
  ...
  - 이것은 전체 이용 내역과 초기 이력을 기반한 군집 분류에 있어, 사용 빈도와 장-단거리 여부, 일상-여행 여부가 중요한 요소임을 나타냄
