...
drop_col = ['member_id', 'member_age','member_gender','member_total_distance', 'member_period', 'usage_per_week',
            'interval_mean','interval_std','usage_time_mean', 'usage_time_std','vroom_per_usage', 'num_trips_mean', 'num_trips_std',
       'car_type_mode', 'car_type_gini', 'attraction_std', 'restaurant_mean',
       'restaurant_std', 'shopping_mean', 'shopping_std']
df = df.drop(columns=drop_col)
df.columns

member_type = df.member_type.unique().tolist()
